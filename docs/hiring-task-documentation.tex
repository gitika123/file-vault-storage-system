...
AI was used as a controlled engineering aid for requirement decomposition, implementation proposals, test generation, security review, UI review, and documentation drafting. The following prompts describe the project workflow without including private conversation history or credentials.

\subsection{How prompts were used}
Each prompt was given one bounded requirement at a time with the relevant repository context and acceptance criteria. The resulting proposal was reviewed by a human, implemented in the appropriate module, tested, and checked against the running application before being described as complete. Secrets, tokens, passwords, and private files were never included in prompts.
...
The final decision for scope, code changes, security, tests, and documentation remained human-controlled. No production credentials, tokens, private files, or secret values are included in source control.
